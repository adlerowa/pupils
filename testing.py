...
file_path = '/Users/aleksandraadler/Desktop/empat/eye_tracker/et_data/Subj2/averages/grand_averages_Subj2.csv'
...
# Remove rows where pupil_value is smaller than -3 or larger than 4
df_long = df_long[(df_long['pupil_value'] > -2) & (df_long['pupil_value'] <= 3)]

# Check the structure of the long DataFrame after filtering
print("Long Format DataFrame after filtering and splitting condition:")
print(df_long.head())

# Save the long format DataFrame to a new CSV file
output_file_path = '/Users/aleksandraadler/Desktop/empat/eye_tracker/et_data/Subj2/averages/long_format_Subj2.csv'
...
for emotion1, emotion2 in emotion_pairs:
    ...
    print(f"\nPerforming t-test between {emotion1} and {emotion2}")
    print("Data for emotion1:")
    print(data_emotion1.head())
    print("Data for emotion2:")
    print(data_emotion2.head())
...
ttest_results_file_path = '/Users/aleksandraadler/Desktop/empat/eye_tracker/et_data/Subj2/averages/ttest_results_Subj2.txt'
...
significant_times_csv_path = '/Users/aleksandraadler/Desktop/empat/eye_tracker/et_data/Subj2/averages/significant_times_Subj2.csv'
...
colors = plt.cm.tab10.colors  # You can choose any color map you prefer
...
plot_file_path = '/Users/aleksandraadler/Desktop/empat/eye_tracker/et_data/Subj2/averages/pupil_size_plot.png'
